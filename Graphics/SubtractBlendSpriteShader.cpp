...
SubtractBlendSpriteShader::SubtractBlendSpriteShader(ID3D11Device* device)
{
	// 頂点シェーダー
	{
		// ファイルを開く
...
// 描画開始
void SubtractBlendSpriteShader::Begin(const RenderContext& rc)
{
...
// 描画
void SubtractBlendSpriteShader::Draw(const RenderContext& rc, const Sprite* sprite)
{
...
// 描画終了
void SubtractBlendSpriteShader::End(const RenderContext& rc)
{
