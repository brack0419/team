...
AddbBlendSpriteShader::AddbBlendSpriteShader(ID3D11Device* device)
{
	// 頂点シェーダー
	{
		// ファイルを開く
...
// 描画開始
void AddbBlendSpriteShader::Begin(const RenderContext& rc)
{
...
// 描画
void AddbBlendSpriteShader::Draw(const RenderContext& rc, const Sprite* sprite)
{
...
// 描画終了
void AddbBlendSpriteShader::End(const RenderContext& rc)
{
